 ...
 * So in our example in the Lagan project the LaganCrew model has a many-to-one relation
 * with the LaganHoverkraft model, and the LaganHoverkraft model has a one-to-many relation
 * with the LaganCrew model.
 *
